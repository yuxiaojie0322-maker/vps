...
基于 **GitHub Actions + Playwright + NopeCHA + Sing-box (TUIC)** 的全自动 [VPSFree.es](https://free.vpsfree.es) 免费 VPS 续期与巡检工具。
...
- 🌐 **内置 TUIC 代理网络**：自动启动 `sing-box` 客户端，完美绕过微软 GitHub 云端机房 IP 拦截风控。
